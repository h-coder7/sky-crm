                            ...
                            <thead>
                                <SortableRow items={visibleColumnOrder}>
                                    ...
                                    {table.getColumn("country").getIsVisible() && (
                                        <SortableTh id="country" key="country">
                                            <span>Country</span>
                                            <div className="dropdown ms-auto" onClick={(e) => e.stopPropagation()}>
                                                <button className="btn bg-transparent border-0 p-0" data-bs-toggle="dropdown">
                                                    <i className="fat fa-sort fsz-12"></i>
                                                ...
                                                <ul className="dropdown-menu shadow-sm border-0 rounded-3">
                                                    <li className="dropdown-item cursor-pointer fsz-12 py-2" onClick={() => table.getColumn("country").toggleSorting(false)}>
                                                        <i className="fal fa-sort-alpha-up me-2 text-muted"></i> (A → Z)
                                                    </li>
                                                    <li className="dropdown-item cursor-pointer fsz-12 py-2" onClick={() => table.getColumn("country").toggleSorting(true)}>
                                                        <i className="fal fa-sort-alpha-down me-2 text-muted"></i> (Z → A)
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    table.getRowModel().rows.map((row) => {
                                        ...
                                        return (
                                            <SortableRow key={row.id} items={visibleColumnOrder}>
                                                ...
                                                {table.getColumn("country").getIsVisible() && (
                                                    <td id="country" key="country">{item.country}</td>
                                                )}
                                                ...
                                                {table.getColumn("columnActions").getIsVisible() && (
                                                    <td id="columnActions" key="columnActions">
                                                        <div className="dropdown">
                                                            ...
                                                            <ul className="dropdown-menu shadow-sm border-0 rounded-3">
                                                                <li><button className="dropdown-item fsz-12 py-2" onClick={() => onEdit?.(item.id)}><i className="fal fa-pen me-2 text-muted"></i> Edit</button></li>
                                                                <li><button className="dropdown-item text-danger fsz-12 py-2" onClick={() => onDelete?.(item.id)}><i className="fal fa-trash me-2 text-muted"></i> Delete</button></li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                )}
